...
namespace ForuMsApi.Test.Core.RawClientTests;
...
public class MultipartFormTests
{
    ...
    private static ForuMsApi.Core.MultipartFormRequest CreateMultipartFormRequest()
    {
        return new ForuMsApi.Core.MultipartFormRequest
        {
