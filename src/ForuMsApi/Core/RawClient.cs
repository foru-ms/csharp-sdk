...
internal partial class RawClient(ClientOptions clientOptions)
{
    ...
    internal global::System.Threading.Tasks.Task<global::ForuMsApi.Core.ApiResponse> MakeRequestAsync(
        global::ForuMsApi.Core.BaseRequest request,
    ...
    internal async global::System.Threading.Tasks.Task<global::ForuMsApi.Core.ApiResponse> SendRequestAsync(
        global::ForuMsApi.Core.BaseRequest request,
        CancellationToken cancellationToken = default
    )
    {
    ...
    /// </summary>
    private async global::System.Threading.Tasks.Task<global::ForuMsApi.Core.ApiResponse> SendWithRetriesAsync(
        HttpRequestMessage request,
        IRequestOptions? options,
    ...
    )
    {
        ...
        {
            return new global::ForuMsApi.Core.ApiResponse
            {
    ...
    private static string BuildUrl(global::ForuMsApi.Core.BaseRequest request)
    {
    ...
    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.ApiResponse instead.")]
    internal record ApiResponse : global::ForuMsApi.Core.ApiResponse;

    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.BaseRequest instead.")]
    internal abstract record BaseApiRequest : global::ForuMsApi.Core.BaseRequest;

    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.EmptyRequest instead.")]
    internal abstract record EmptyApiRequest : global::ForuMsApi.Core.EmptyRequest;

    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.JsonRequest instead.")]
    internal abstract record JsonApiRequest : global::ForuMsApi.Core.JsonRequest;

    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.MultipartFormRequest instead.")]
    internal abstract record MultipartFormRequest : global::ForuMsApi.Core.MultipartFormRequest;

    /// <inheritdoc />
    [Obsolete("Use global::ForuMsApi.Core.StreamRequest instead.")]
    internal abstract record StreamApiRequest : global::ForuMsApi.Core.StreamRequest;
}
