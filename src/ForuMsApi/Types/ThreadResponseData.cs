...
[Serializable]
public record ThreadResponseData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public ThreadResponseDataPoll? Poll { get; set; }
    ...
    public IEnumerable<ThreadResponseDataReactionsItem>? Reactions { get; set; }
