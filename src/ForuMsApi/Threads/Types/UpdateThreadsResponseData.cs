...
[Serializable]
public record UpdateThreadsResponseData : IJsonOnDeserialized
{
    [JsonExtensionData]
    ...
    public UpdateThreadsResponseDataPoll? Poll { get; set; }
    ...
    public IEnumerable<UpdateThreadsResponseDataReactionsItem>? Reactions { get; set; }
